...
open class PinnLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            MAP=40, SLICE=41, LSQUARE=42, LPAREN=43, NIL=44, COMMA=45, COLON=46, 
            CE=47, IOTA=48, RANGE=49, AST=50, THREEDOT=51, TWODOTS=52, CARET=53, 
            ID=54, INT=55, FLOAT=56, WS=57, STRING=58
	...
	static let ruleNames: [String] = [
		...
		"T__33", "T__34", "T__35", "TYPES", "DOUBLEOP", "BOOL", "MAP", "SLICE", 
		"LSQUARE", "LPAREN", "NIL", "COMMA", "COLON", "CE", "IOTA", "RANGE", "AST", 
		"THREEDOT", "TWODOTS", "CARET", "ID", "INT", "FLOAT", "WS", "STRING", 
