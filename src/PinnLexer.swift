...
open class PinnLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__33=34, MAP=35, SLICE=36, TYPES=37, BINOP=38, LSQUARE=39, 
            LPAREN=40, NIL=41, COMMA=42, COLON=43, CE=44, IOTA=45, RANGE=46, 
            AST=47, THREEDOT=48, TWODOTS=49, CARET=50, DOUBLEOP=51, BOOL=52, 
	...
	static let ruleNames: [String] = [
		...
		"T__33", "MAP", "SLICE", "TYPES", "BINOP", "LSQUARE", "LPAREN", "NIL", 
		"COMMA", "COLON", "CE", "IOTA", "RANGE", "AST", "THREEDOT", "TWODOTS", 
		"CARET", "DOUBLEOP", "BOOL", "ID", "CHAR", "INT", "FLOAT", "WS", "STRING", 
		"DECIMAL_DIGIT", "DECIMAL_DIGITS", "DECIMAL_EXPONENT"
	]
